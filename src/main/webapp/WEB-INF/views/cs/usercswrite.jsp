                                ...
                                <div class="row g-3">
                                    <div class="col-md-8">
                                        <div class="form-floating" style="margin:auto;">
                                            <input type="text" class="form-control" id="name" placeholder="" name="cs_title">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select border-1 py-3" name="cs_category" id="category">
			     							<option value="no">카테고리</option>
			     							<option value="광고문의">광고 문의</option>
			     							<option value="유저신고" >유저 신고</option>
			     							<option value="일반문의" >일반 문의</option>
			     							<option value="공동구매 문의" >공동구매 문의</option>
			     					...
			     					<div class="col-md-12">
                                        <div class="form-floating" style="margin:auto;">
                                            <input type="file" class="form-control" id="name" placeholder="" name="cs_img" accept="image/*" onchange="readURL(this)">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a message here" id="message" style="height: 150px" name="cs_cont"></textarea>
