...
public class ImgFile {
	 public static void save(//UserVo vo,
	        ...
	        String r_reviewimg  = null; // 저장된 실제 파일명
	        ...
	        while (iterator.hasNext()) {
	            ...
	            if ( !multipartFile.isEmpty() ) {
	                ...
	                r_reviewimg = checkFile.getCheckFileName(filePath, orgFileName, u_imgext);

	                File file = new File(filePath + r_reviewimg);
	                try {
	        ...
	        map.put("r_reviewimg", r_reviewimg);
