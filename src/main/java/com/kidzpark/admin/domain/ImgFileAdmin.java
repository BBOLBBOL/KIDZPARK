package com.kidzpark.admin.domain;
	 ...
	 public static void save(//UserVo vo,
	        ...
	        while (iterator.hasNext()) {
	            ...
	            if ( !multipartFile.isEmpty() ) {
	                ...
	                kz_img = checkFile.getCheckFileName(filePath, orgFileName, u_imgext);

	                File file = new File(filePath + kz_img);
	                try {
